...
Streamlink is possibly the best and the most stable way to live record Niconico streams.

But it can take up to hours if you are going to do the archive after stream. I recommend using `minyami` instead.
